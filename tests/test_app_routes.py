...
class AppRouteTests(unittest.TestCase):
    def setUp(self):
        ...
        flask_module.request = SimpleNamespace(get_json=lambda silent=False: {})
    ...
    def test_slack_url_verification_returns_challenge_before_bolt_handler(self):
        env = {
        ...
        app_module._failed_bots["assistant"] = "simulated initialization failure"
        ...
        self.assertEqual(
            app_module.bot_slack_events("assistant"),
            {"challenge": "challenge-placeholder"},
        )
